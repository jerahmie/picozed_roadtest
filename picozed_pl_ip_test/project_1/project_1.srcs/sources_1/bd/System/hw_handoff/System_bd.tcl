...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.GPIO_BOARD_INTERFACE {pl_pb_1bit} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports pl_pb_1bit] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports pl_led_1bit] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins my_multiplier_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs my_multiplier_0/S00_AXI/S00_AXI_reg] SEG_my_multiplier_0_S00_AXI_reg
